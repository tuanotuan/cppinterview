# Câu 146: Một hàm nên có bao nhiêu câu lệnh `return`?
...
Không có giới hạn phổ quát hữu ích. Nhiều early return và guard clause thường làm hàm ngắn rõ hơn nhờ giảm nesting; nếu quá nhiều exit khó suy luận, hãy giảm kích thước và trách nhiệm của hàm thay vì ép giáo điều chỉ một `return`.
...
1. Dễ — Một hàm nên có bao nhiêu câu lệnh `return`?
