...
Undefined behavior preserves room for efficient low-level implementations, avoids mandatory checks and semantics that would penalize valid programs, and accommodates diverse hardware. That freedom is useful only when programs uphold the language and library preconditions.
...
1. Hard — What are the reasons behind undefined behaviour’s existence?
