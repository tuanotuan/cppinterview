# Câu 137: Làm sao giúp compiler thực hiện RVO?
...
Hãy trả prvalue trực tiếp khi có thể để nhận elision được bảo đảm từ C++17, hoặc trả cùng một named local trên các nhánh liên quan để NRVO có thể xảy ra. Không viết `std::move(local)` ở return vì thường làm mất NRVO.
...
1. Trung bình — Làm sao giúp compiler thực hiện RVO?
