# Câu 058: `std::move` thực sự di chuyển điều gì?
...
`std::move` tự nó không di chuyển gì; nó cast đối số thành xvalue để overload resolution có thể chọn move operation. Operation được chọn mới quyết định thứ gì được chuyển, còn source vẫn hợp lệ nhưng thường có giá trị unspecified.
