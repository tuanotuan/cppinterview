# Câu 095: Abstract class trong C++ là gì?
...
Abstract class có ít nhất một pure virtual function và không thể khởi tạo trực tiếp. Nó vẫn có thể giữ state, định nghĩa constructor, concrete function và thậm chí cung cấp definition cho pure virtual function.
...
1. Dễ — Abstract class trong C++ là gì?
