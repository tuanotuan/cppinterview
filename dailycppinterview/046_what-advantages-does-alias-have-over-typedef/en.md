# Question 046: What advantages does alias have over typedef?
...
A `using` alias reads left-to-right and, unlike `typedef`, can define alias templates. Both name an existing type rather than create a new strong type.
...
1. Easy — What advantages does alias have over typedef?
