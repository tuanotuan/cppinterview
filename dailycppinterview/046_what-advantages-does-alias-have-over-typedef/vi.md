# Câu 046: Alias có lợi thế gì so với `typedef`?
...
Alias bằng `using` đọc từ trái sang phải và khác `typedef` ở chỗ có thể định nghĩa alias template. Cả hai chỉ đặt tên khác cho kiểu có sẵn chứ không tạo strong type mới.
...
1. Dễ — Alias có lợi thế gì so với `typedef`?
