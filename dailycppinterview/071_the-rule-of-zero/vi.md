# Câu 071: Giải thích Rule of Zero.
...
Rule of Zero nói rằng lớp ứng dụng nên kết hợp các RAII value type để không cần custom destructor, copy hay move operation. Special member do compiler sinh sẽ giữ value semantics đúng với ít code hơn.
