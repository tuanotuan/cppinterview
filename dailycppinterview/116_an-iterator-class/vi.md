...
Iterator là abstraction xác định một vị trí và hỗ trợ operation theo iterator category hoặc concept; nó không bắt buộc phải là một class. Algorithm phụ thuộc các operation có semantics đó thay vì một concrete container type.
