# Question 094: Should base class destructors be virtual?
...
A base destructor should be public and virtual when objects may be deleted through base pointers. If deletion through the base is forbidden, a protected non-virtual destructor is a valid alternative; adding virtual solely by habit imposes polymorphic layout.
...
1. Medium — Should base class destructors be virtual?
