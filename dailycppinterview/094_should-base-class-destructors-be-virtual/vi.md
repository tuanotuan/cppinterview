# Câu 094: Destructor của lớp cơ sở có nên là `virtual` không?
...
Destructor của base nên public và virtual khi object có thể bị xóa qua base pointer. Nếu cấm xóa qua base, destructor protected non-virtual là lựa chọn hợp lệ; thêm virtual theo thói quen sẽ áp đặt polymorphic layout.
...
1. Trung bình — Destructor của lớp cơ sở có nên là `virtual` không?
