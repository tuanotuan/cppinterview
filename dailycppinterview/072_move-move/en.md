# Question 072: What does std::move move?
...
`std::move` is a cast to an xvalue, not a transfer operation. A subsequent constructor or assignment may move resources, and the source remains valid but its value may be unspecified.
