# Câu 072: `std::move` thực sự di chuyển điều gì?
...
`std::move` là phép cast thành xvalue chứ không phải operation chuyển resource. Constructor hoặc assignment sau đó có thể thực hiện move; source vẫn hợp lệ nhưng giá trị có thể unspecified.
...
1. Dễ — `std::move` thực sự di chuyển điều gì?
