# Câu 048: Nên `delete` tường minh special function không hỗ trợ hay khai báo nó là `private`?
...
Nên ưu tiên khai báo deleted ở `public`: nó nêu operation không hỗ trợ ngay trong interface và tạo diagnostic compile-time trực tiếp bất kể access context. Hàm private chỉ khai báo là kỹ thuật trước C++11, kém rõ ràng hơn.
...
Dùng kiến thức này khi review API, đọc code, giải thích diagnostic hoặc thiết kế abstraction có liên quan đến thực hành C++ hiện đại. Trong code production, hãy ưu tiên dạng làm contract hiện rõ và được compiler kiểm tra.
...
1. Trung bình — Nên `delete` tường minh special function không hỗ trợ hay khai báo nó là `private`?
