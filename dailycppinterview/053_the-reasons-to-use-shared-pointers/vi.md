# Câu 053: Vì sao nên dùng `shared_ptr`?
...
Chỉ dùng `std::shared_ptr` khi nhiều owner độc lập thật sự cùng quyết định một lifetime. Reference counting làm ownership rõ ràng nhưng thêm control block, chi phí đếm thường dùng atomic và không làm pointee tự động thread-safe.
...
1. Dễ — Vì sao nên dùng `shared_ptr`?
