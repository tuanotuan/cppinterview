# Câu 160: Abstract class và interface trong C++ khác nhau thế nào? Làm sao triển khai hành vi giống interface?
...
Abstract class có ít nhất một pure virtual function và vẫn có thể sở hữu state, constructor, function không virtual hay virtual function đã có implementation. C++ không có keyword `interface`; contract runtime giống interface thường là abstract class chỉ chứa các operation pure virtual cần thiết cùng virtual destructor khi hỗ trợ xóa qua base. C++20 concept là một dạng contract compile time riêng cho generic code, không cần inheritance hay runtime dispatch.
...
1. Trung bình — Abstract class và interface trong C++ khác nhau thế nào? Làm sao triển khai hành vi giống interface?
