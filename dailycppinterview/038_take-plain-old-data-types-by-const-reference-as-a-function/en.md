# Question 038: Should you take plain old data types by const reference as a function parameter?
...
Small scalar and other cheap value types should normally be passed by value; a reference can cost the same size while adding indirection and aliasing. Use const reference when copying is materially expensive or identity matters.
...
1. Medium — Should you take plain old data types by const reference as a function parameter?
