# Câu 097: Làm sao thêm chức năng vào lớp bằng Curiously Recurring Template Pattern (CRTP)?
...
CRTP truyền kiểu dẫn xuất làm template argument cho base, cho phép base gọi hành vi dẫn xuất qua `static_cast<Derived&>(*this)`. Nó tạo mixin compile-time không cần virtual dispatch, nhưng quan hệ và giả định lifetime phải rõ ràng.
...
1. Khó — Làm sao thêm chức năng vào lớp bằng Curiously Recurring Template Pattern (CRTP)?
