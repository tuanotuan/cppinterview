# Câu 088: User-defined literal là gì?
...
User-defined literal dùng literal operator và suffix như `_ms` để tạo domain value trực tiếp từ cú pháp literal. Cần giữ conversion rule tường minh và đặt suffix tránh vùng tên dành riêng.
