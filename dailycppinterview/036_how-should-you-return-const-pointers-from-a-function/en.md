# Question 036: How should you return const pointers from a function?
...
Return a pointer-to-const, `const T*`, when the caller may observe but not mutate the pointee through that handle. Making the pointer value itself top-level const in a return type is discarded and does not constrain the caller.
...
1. Medium — How should you return const pointers from a function?
