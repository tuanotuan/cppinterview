# Câu 019: Chương trình mẫu sau in gì? Đó có phải điều bạn mong đợi không? Vì sao?
...
Chương trình in lần lượt `Dog speaks`, `Dog eats 42`, `Animal speaks`, rồi `Animal eats 42`. `speak` không phải virtual, còn `Dog::eat(unsigned)` không override `Animal::eat(int)`; thêm `override` sẽ làm lộ cả hai lỗi ngay khi compile.
...
1. Khó — Chương trình mẫu sau in gì? Đó có phải điều bạn mong đợi không? Vì sao?
