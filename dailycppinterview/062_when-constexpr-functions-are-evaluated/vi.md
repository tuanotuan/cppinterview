# Câu 062: Khi nào hàm `constexpr` được đánh giá?
...
Hàm `constexpr` có thể chạy ở compile time khi được gọi bằng đối số phù hợp trong context yêu cầu constant expression, nhưng cũng có thể chạy ở runtime. Dùng `consteval` khi việc đánh giá compile-time là bắt buộc.
...
1. Trung bình — Khi nào hàm `constexpr` được đánh giá?
