# Câu 012: Làm thế nào để giải quyết thảm họa thứ tự khởi tạo tĩnh?
...
Cách sửa phổ biến là construct-on-first-use: trả về function-local static để nó được khởi tạo ở lần gọi đầu và thread-safe từ C++11. Đồng thời giảm global state và biểu diễn dependency tường minh; chỉ thêm inline variable không sửa được thiết kế khởi tạo vòng.
...
Dùng kiến thức này khi review API, đọc code, giải thích diagnostic hoặc thiết kế abstraction có liên quan đến static và khởi tạo. Trong code production, hãy ưu tiên dạng làm contract hiện rõ và được compiler kiểm tra.
...
1. Trung bình — Làm thế nào để giải quyết thảm họa thứ tự khởi tạo tĩnh?
