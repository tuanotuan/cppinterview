...
Concept là predicate compile-time có tên dùng để ràng buộc template argument. Nó đưa requirement vào interface, tham gia sắp thứ tự overload và thường tạo diagnostic gần requirement bị vi phạm hơn.
