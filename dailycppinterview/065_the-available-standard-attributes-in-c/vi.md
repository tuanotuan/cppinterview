# Câu 065: C++ có những standard attribute nào?
...
Standard attribute dùng cú pháp `[[...]]`. Trong C++11–20, các attribute chính gồm `noreturn`, `carries_dependency`, `deprecated`, `fallthrough`, `nodiscard`, `maybe_unused`, `likely`, `unlikely` và `no_unique_address`; quy tắc hỗ trợ và vị trí phụ thuộc chuẩn đang dùng.
...
1. Dễ — C++ có những standard attribute nào?
