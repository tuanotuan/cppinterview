# Câu 100: Một chương trình C++ ill-formed có những đặc điểm gì?
...
Chương trình ill-formed vi phạm syntax rule, semantic constraint hoặc yêu cầu có diagnostic của C++. Implementation phù hợp phải phát ít nhất một diagnostic cho vi phạm cần chẩn đoán; trường hợp ill-formed, no diagnostic required có thể không bị phát hiện.
...
1. Dễ — Một chương trình C++ ill-formed có những đặc điểm gì?
