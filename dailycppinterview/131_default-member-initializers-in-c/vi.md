# Câu 131: Default Member Initializer trong C++ là gì?
...
Default member initializer cung cấp giá trị ban đầu khi constructor không khởi tạo tường minh member đó. Member vẫn được khởi tạo theo thứ tự khai báo và member initializer trong constructor sẽ override default cho lần construction ấy.
...
1. Dễ — Default Member Initializer trong C++ là gì?
