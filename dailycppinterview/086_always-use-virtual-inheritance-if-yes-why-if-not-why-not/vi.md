# Câu 086: Có nên luôn dùng kế thừa ảo không? Nếu có, vì sao? Nếu không, vì sao?
...
Không nên dùng kế thừa ảo mặc định. Chỉ dành nó cho thiết kế cần một base identity dùng chung trong cấu trúc kim cương và chấp nhận chi phí layout, initialization và coupling tăng thêm.
