# Question 086: Should we always use virtual inheritance? If yes, why? If not, why not?
...
Do not use virtual inheritance by default. Reserve it for designs that require one shared base identity across a diamond and accept the extra layout, initialization, and coupling costs.
