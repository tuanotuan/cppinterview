# Câu 111: Bộ nhớ của `vector` được tổ chức như thế nào?
...
`std::vector` lưu phần tử liên tục trong một allocation và theo dõi logical size bên trong capacity. Khi tăng vượt capacity, nó cấp block mới rồi move hoặc copy phần tử, làm vô hiệu pointer, reference và iterator tới storage cũ.
...
1. Dễ — Bộ nhớ của `vector` được tổ chức như thế nào?
