...
A `std::vector` stores its elements contiguously in one allocation and tracks a logical size within a capacity. Growth beyond capacity allocates a new block and moves or copies elements, invalidating pointers, references, and iterators to the old storage.
...
1. Easy — How is a vector’s memory layout organized?
