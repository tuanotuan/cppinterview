...
Include guard bọc header trong một preprocessor macro duy nhất để việc include lặp trong một translation unit không lặp lại declaration và definition. `#pragma once` được hỗ trợ rộng nhưng không thuộc chuẩn; macro guard vẫn là cơ chế portable.
