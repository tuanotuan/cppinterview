# Câu 022: Có thể gọi hàm ảo từ constructor hoặc destructor không?
...
Có thể gọi hàm ảo trong constructor hoặc destructor, nhưng dispatch dừng ở lớp đang được xây dựng hoặc hủy. Phần dẫn xuất sâu hơn chưa còn hoạt động; gọi pure virtual function trong tình huống đó là không hợp lệ.
...
1. Khó — Có thể gọi hàm ảo từ constructor hoặc destructor không?
