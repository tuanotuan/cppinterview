...
STL thường chỉ tập container, iterator, algorithm, function object và utility generic được chuẩn hóa từ thiết kế Standard Template Library ban đầu. Toàn bộ thư viện chuẩn C++ rộng hơn, còn gồm I/O, threading, filesystem và nhiều phần khác.
