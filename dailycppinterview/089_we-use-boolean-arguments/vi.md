# Câu 089: Vì sao không nên dùng tham số boolean?
...
Tham số boolean che ý nghĩa tại call site và thường báo hiệu hai hành vi bị nhét vào một hàm. Nên dùng enum có tên, options type hoặc các hàm tên riêng khi lựa chọn biểu diễn mode nghiệp vụ thay vì predicate đơn giản.
...
1. Trung bình — Vì sao không nên dùng tham số boolean?
