# Question 089: Why shouldn’t we use boolean arguments?
...
A boolean argument hides meaning at the call site and often signals two behaviors packed into one function. Prefer a named enum, options type, or separate named functions when the choice represents a domain mode rather than a simple predicate.
...
1. Medium — Why shouldn’t we use boolean arguments?
