# Question 099: What is observable behaviour of code?
...
Observable behavior is the part of execution the abstract machine requires an implementation to preserve, such as specified I/O effects and accesses to volatile objects under the applicable rules. The as-if rule permits any optimization that leaves required observations unchanged.
...
1. Medium — What is observable behaviour of code?
