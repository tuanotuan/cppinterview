# Câu 099: Observable behavior của chương trình là gì?
...
Observable behavior là phần thực thi mà abstract machine yêu cầu implementation phải giữ, như hiệu ứng I/O được quy định và truy cập volatile object theo rule áp dụng. As-if rule cho phép mọi tối ưu miễn các quan sát bắt buộc không đổi.
...
1. Trung bình — Observable behavior của chương trình là gì?
