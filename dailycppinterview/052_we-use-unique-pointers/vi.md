# Câu 052: Khi nào nên dùng `unique_ptr`?
...
Dùng `std::unique_ptr` khi một object sở hữu độc quyền resource cấp phát động và ownership có thể được chuyển giao. Ưu tiên object trực tiếp nếu không cần cấp phát hoặc nullable ownership; truyền observer bằng reference hay raw pointer.
...
1. Dễ — Khi nào nên dùng `unique_ptr`?
