# Câu 096: Có thể có hành vi đa hình mà không chịu chi phí của hàm ảo không?
...
Có. Template, CRTP, concept và discriminated union như `std::variant` có thể cung cấp static hoặc closed-set polymorphism mà không cần virtual dispatch. Đổi lại là coupling ở compile time, code size và khả năng mở rộng runtime thấp hơn.
...
1. Khó — Có thể có hành vi đa hình mà không chịu chi phí của hàm ảo không?
