...
`volatile` tells the implementation that accesses are observable in a limited, implementation-oriented sense, useful mainly for some memory-mapped I/O and signal scenarios. It provides neither atomicity nor inter-thread synchronization; use atomics for concurrency.
...
1. Easy — What is the function of the keyword volatile?
