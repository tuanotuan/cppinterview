# Câu 122: Từ khóa `volatile` có tác dụng gì?
...
`volatile` báo cho implementation rằng access có tính quan sát theo nghĩa giới hạn, chủ yếu hữu ích cho một số memory-mapped I/O và signal. Nó không cung cấp atomicity hay synchronization giữa thread; concurrency phải dùng atomic.
...
1. Dễ — Từ khóa `volatile` có tác dụng gì?
