# Question 010: What does a static member function mean in C++?
...
A static member function has no `this` pointer and can be called through the class name. It can directly access only static members, although it may operate on objects passed explicitly.
...
1. Easy — What does a static member function mean in C++?
