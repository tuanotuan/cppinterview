# Câu 010: Hàm thành viên `static` trong C++ có ý nghĩa gì?
...
Hàm thành viên `static` không có con trỏ `this` và có thể gọi qua tên lớp. Nó chỉ truy cập trực tiếp được static member, nhưng vẫn có thể thao tác trên object được truyền tường minh.
...
1. Dễ — Hàm thành viên `static` trong C++ có ý nghĩa gì?
