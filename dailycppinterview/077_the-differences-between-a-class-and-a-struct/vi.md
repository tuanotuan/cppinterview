# Câu 077: Class và struct khác nhau ở những điểm nào?
...
`class` và `struct` có cùng khả năng ngôn ngữ. Khác biệt dựng sẵn chỉ là mặc định: member và base của `class` là private, của `struct` là public; theo convention, struct thường biểu diễn dữ liệu trong suốt còn class bảo vệ invariant.
...
1. Dễ — Class và struct khác nhau ở những điểm nào?
