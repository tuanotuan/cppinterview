# Câu 079: Giải thích kiểu trả về hiệp biến và đưa ra một trường hợp nó hữu ích!
...
Covariant return cho phép override thu hẹp pointer hoặc reference trả về thành kiểu dẫn xuất. Quy tắc chỉ áp dụng cho pointer/reference tới class tương thích, không áp dụng tùy ý cho value hay smart pointer.
