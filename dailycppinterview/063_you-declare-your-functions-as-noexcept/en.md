# Question 063: When should you declare your functions as noexcept?
...
Declare a function `noexcept` when throwing would violate its contract, especially destructors, swap-like operations, and move operations that containers can safely prefer. If an exception escapes, the program terminates, so use conditional `noexcept` for generic code whose operations may throw.
...
1. Hard — When should you declare your functions as noexcept?
