# Câu 063: Khi nào nên khai báo hàm là `noexcept`?
...
Khai báo hàm `noexcept` khi việc ném exception vi phạm contract, đặc biệt với destructor, operation dạng swap và move operation để container có thể ưu tiên an toàn. Nếu exception thoát ra, chương trình terminate; generic code nên dùng conditional `noexcept` khi operation bên trong có thể ném.
...
1. Khó — Khi nào nên khai báo hàm là `noexcept`?
