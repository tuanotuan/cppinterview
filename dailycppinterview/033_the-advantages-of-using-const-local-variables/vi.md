# Câu 033: Biến cục bộ `const` có những lợi ích gì?
...
Biến cục bộ const cho biết giá trị ổn định sau khởi tạo và giúp compiler chặn việc ghi nhầm. Nó giảm lượng mutable state người đọc phải theo dõi, nhưng không nên thêm const khi việc gán lại là có chủ ý.
...
1. Dễ — Biến cục bộ `const` có những lợi ích gì?
