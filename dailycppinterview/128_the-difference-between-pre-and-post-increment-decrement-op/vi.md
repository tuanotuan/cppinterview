# Câu 128: Giải thích sự khác nhau giữa toán tử tăng/giảm trước và sau.
...
Prefix increment sửa toán hạng rồi trả object đã tăng, thường dưới dạng lvalue reference. Postfix increment cũng sửa toán hạng nhưng trả giá trị cũ thành kết quả riêng, có thể tốn thêm công việc với user-defined type.
...
1. Dễ — Giải thích sự khác nhau giữa toán tử tăng/giảm trước và sau.
