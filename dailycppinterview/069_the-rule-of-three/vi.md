# Câu 069: Giải thích Rule of Three.
...
Nếu một lớp trực tiếp quản lý resource và cần destructor tự định nghĩa, nó thường cũng cần copy constructor và copy assignment operator có ownership semantics nhất quán. Rule of Three nhắc phải định nghĩa hoặc delete toàn bộ copy contract.
