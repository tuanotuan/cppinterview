# Câu 073: Destructor là gì và có thể overload nó như thế nào?
...
Destructor thực hiện cleanup khi kết thúc lifetime và mỗi lớp chỉ có đúng một chữ ký destructor. Nó không thể overload, dù có thể là virtual, defaulted, deleted hoặc bị ràng buộc bởi access.
