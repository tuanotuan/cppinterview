# Câu 126: Những khai báo biến nào sau đây biên dịch được và giá trị của `a` là bao nhiêu?
...
Khai báo 1, 2 và 3 biên dịch được. Hai khai báo đầu cho 42; gán `-42` chuyển theo modulo lớn hơn giá trị unsigned tối đa một đơn vị, còn braced initialization ở khai báo 4 từ chối narrowing conversion đó.
...
1. Khó — Những khai báo biến nào sau đây biên dịch được và giá trị của `a` là bao nhiêu?
