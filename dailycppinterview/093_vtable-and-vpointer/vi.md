# Câu 093: Vtable và vpointer là gì?
...
Vtable là cách implementation phổ biến lưu bảng đích của virtual function, còn vpointer là pointer ẩn trong object để truy cập bảng đó. Chuẩn quy định hành vi virtual call chứ không bắt mọi implementation dùng đúng layout này.
...
1. Khó — Vtable và vpointer là gì?
