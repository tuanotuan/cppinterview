# Question 093: What are vtable and vpointer?
...
A vtable is a common implementation table of virtual-function targets, and a vpointer is a hidden per-object pointer used to reach it. The standard specifies virtual-call behavior, not that every implementation must use exactly this layout.
...
1. Hard — What are vtable and vpointer?
