# Câu 127: Dòng mã dưới đây in gì và vì sao?
...
`25u - 50` được tính theo unsigned arithmetic vì toán hạng signed chuyển sang unsigned. Kết quả wrap theo modulo `UINT_MAX + 1`, thành `UINT_MAX - 24`; con số 4294967271 chỉ đúng khi `unsigned int` có 32 bit.
...
1. Khó — Dòng mã dưới đây in gì và vì sao?
