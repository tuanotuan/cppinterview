# Câu 102: Implementation-defined behavior là gì?
...
Implementation-defined behavior cho phép mỗi implementation chọn một hành vi hợp lệ nhưng phải document lựa chọn đó, chẳng hạn kích thước hoặc ánh xạ của một số kiểu. Code portable phải tránh phụ thuộc hoặc kiểm tra rõ target đã document.
...
1. Dễ — Implementation-defined behavior là gì?
