# Câu 041: Giải thích `consteval` và `constinit` mang lại điều gì cho C++?
...
`consteval` khai báo immediate function mà các lời gọi được đánh giá phải tạo hằng compile-time. `constinit` áp dụng cho static hoặc thread storage và bắt buộc static initialization, nhưng không làm object bất biến.
