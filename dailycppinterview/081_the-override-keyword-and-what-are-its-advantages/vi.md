# Câu 081: Từ khóa `override` là gì và có những lợi ích nào?
...
`override` biến ý định override thành contract được compiler kiểm tra. Nó bắt sai khác về cv/ref qualifier, tham số và các phần chữ ký khác vốn có thể âm thầm hide hoặc overload hàm base.
...
1. Trung bình — Từ khóa `override` là gì và có những lợi ích nào?
