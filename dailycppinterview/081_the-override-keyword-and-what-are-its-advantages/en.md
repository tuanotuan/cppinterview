# Question 081: What is the override keyword and what are its advantages?
...
`override` turns the intention to override into a checked compiler contract. It catches cv/ref qualifier, parameter, and other signature mismatches that would otherwise silently hide or overload a base function.
...
1. Medium — What is the override keyword and what are its advantages?
