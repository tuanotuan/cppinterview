# Câu 015: Từ khóa `override` là gì và có những lợi ích nào?
...
`override` yêu cầu compiler xác nhận khai báo ở lớp dẫn xuất thật sự override một hàm ảo của lớp cơ sở. Sai khác chữ ký sẽ thành lỗi compile thay vì âm thầm tạo overload khác.
