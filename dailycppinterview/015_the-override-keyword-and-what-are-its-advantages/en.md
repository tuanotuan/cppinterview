# Question 015: What is the override keyword and what are its advantages?
...
`override` tells the compiler that a derived declaration must override a virtual base function. A signature mismatch then becomes a compile error instead of silently creating a different overload.
