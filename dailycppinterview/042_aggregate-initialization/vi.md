# Câu 042: Aggregate initialization là gì?
...
Aggregate initialization khởi tạo trực tiếp các phần tử của aggregate từ braced list, theo thứ tự khai báo hoặc bằng designated initializer khi được hỗ trợ. Một lớp có phải aggregate hay không phụ thuộc quy tắc của từng chuẩn về constructor, base, virtual function và access.
...
1. Dễ — Aggregate initialization là gì?
