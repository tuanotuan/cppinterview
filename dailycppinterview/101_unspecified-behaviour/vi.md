# Câu 101: Unspecified behavior là gì?
...
Unspecified behavior nghĩa là chuẩn cho phép một trong nhiều kết quả hợp lệ và implementation không phải ghi lại lựa chọn nào xảy ra ở một lần đánh giá cụ thể. Chương trình phải đúng với mọi lựa chọn được phép.
...
1. Dễ — Unspecified behavior là gì?
