# Câu 145: Nên dùng dấu ngoặc nhọn hay dấu ngoặc kép trong `#include`?
...
Dấu ngoặc kép thường tìm ở vị trí tương đối hoặc user header trước include path của implementation, còn ngoặc nhọn dùng cách tìm kiểu system. Thứ tự chính xác phụ thuộc implementation; convention là dùng ngoặc kép cho header nội bộ dự án và ngoặc nhọn cho standard/external dependency.
...
1. Dễ — Nên dùng dấu ngoặc nhọn hay dấu ngoặc kép trong `#include`?
