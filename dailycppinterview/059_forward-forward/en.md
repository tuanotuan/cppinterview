# Question 059: What does std::forward forward?
...
`std::forward<T>` conditionally casts a forwarding-reference argument according to deduced `T`, preserving whether the original caller supplied an lvalue or rvalue. Use it only with the matching deduced template parameter.
...
1. Easy — What does std::forward forward?
