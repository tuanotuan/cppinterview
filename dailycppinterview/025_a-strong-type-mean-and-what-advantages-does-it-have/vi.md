# Câu 025: Strong type là gì và có những lợi ích nào?
...
Strong type bọc representation trong một domain type riêng, khiến các giá trị có cùng kiểu nền không thể bị trộn nhầm. Nó tập trung invariant, làm overload an toàn hơn và giúp interface tự mô tả.
...
1. Trung bình — Strong type là gì và có những lợi ích nào?
