# Câu 031: Lambda expression có những kiểu capture nào?
...
Capture có thể tường minh theo giá trị hoặc reference, mặc định bằng `[=]` hay `[&]`, gồm `this` hoặc `*this`, và dùng init-capture để tạo member mới trong closure. Nên chọn theo lifetime và nhu cầu mutation thay vì dùng mặc định thiếu cân nhắc.
...
Dùng kiến thức này khi review API, đọc code, giải thích diagnostic hoặc thiết kế abstraction có liên quan đến biểu thức lambda. Trong code production, hãy ưu tiên dạng làm contract hiện rõ và được compiler kiểm tra.
...
1. Dễ — Lambda expression có những kiểu capture nào?
