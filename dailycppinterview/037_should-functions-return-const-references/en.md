# Question 037: Should functions return const references?
...
A function may return a const reference only when the referred object is guaranteed to outlive every use by the caller. It avoids a copy and prevents mutation through that reference, but returning a local or short-lived subobject dangles.
...
1. Medium — Should functions return const references?
