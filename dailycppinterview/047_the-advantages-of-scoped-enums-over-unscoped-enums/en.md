# Question 047: What are the advantages of scoped enums over unscoped enums?
...
A scoped enum (`enum class`) keeps enumerators in its scope, avoids implicit conversion to integers, and allows an explicit underlying type. These properties reduce name collisions and accidental arithmetic.
...
1. Easy — What are the advantages of scoped enums over unscoped enums?
