# Câu 047: Scoped enum có lợi thế gì so với unscoped enum?
...
Scoped enum (`enum class`) giữ enumerator trong scope của enum, tránh implicit conversion sang số nguyên và cho phép chọn underlying type tường minh. Các đặc điểm này giảm đụng tên và phép toán ngoài ý muốn.
...
1. Dễ — Scoped enum có lợi thế gì so với unscoped enum?
