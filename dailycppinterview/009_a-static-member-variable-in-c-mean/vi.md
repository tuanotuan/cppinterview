# Câu 009: Biến thành viên `static` trong C++ có ý nghĩa gì?
...
Biến thành viên `static` thuộc về lớp thay vì từng object, nên mọi instance dùng chung một vùng lưu trữ. Quy tắc định nghĩa và khởi tạo phụ thuộc việc nó có phải inline static member hay không và chuẩn ngôn ngữ đang dùng.
...
1. Dễ — Biến thành viên `static` trong C++ có ý nghĩa gì?
