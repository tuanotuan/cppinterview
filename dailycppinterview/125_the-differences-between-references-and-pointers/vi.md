# Câu 125: Reference và pointer khác nhau thế nào?
...
Reference là alias phải được khởi tạo và không thể reseat; pointer là object có thể null, gán lại và thực hiện pointer arithmetic khi hợp lệ. Cả hai đều có thể dangling và tự chúng không biểu diễn ownership.
...
1. Dễ — Reference và pointer khác nhau thế nào?
