# Câu 026: Giải thích short-circuit evaluation.
...
`&&` dừng sau toán hạng trái false và `||` dừng sau toán hạng trái true vì kết quả cuối đã xác định. Cơ chế sequencing này thường được dùng để bảo vệ operation phía sau vốn sẽ không hợp lệ nếu luôn chạy.
...
1. Dễ — Giải thích short-circuit evaluation.
