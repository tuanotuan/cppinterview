# Question 026: Explain short-circuit evaluation
...
`&&` stops after a false left operand and `||` stops after a true left operand because the final result is already known. This sequencing is often used to guard a later operation that would otherwise be invalid.
...
1. Easy — Explain short-circuit evaluation
