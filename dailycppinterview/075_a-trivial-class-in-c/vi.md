# Câu 075: Trivial class trong C++ là gì?
...
Triviality nghĩa là operation construction, copy, move hoặc destruction tương ứng không cần hành động tùy chỉnh theo quy tắc chuẩn. Hãy dùng trait như `std::is_trivially_copyable_v<T>` cho đúng property thay vì đoán theo hình thức lớp.
