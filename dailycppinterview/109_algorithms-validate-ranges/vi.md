# Câu 109: Thuật toán chuẩn có kiểm tra tính hợp lệ của range không?
...
Algorithm thường tin iterator range và precondition đã document; chúng không xác minh hai iterator tạo range hợp lệ hay yêu cầu ordering đã đúng. Vi phạm contract đó có thể làm chương trình undefined.
...
1. Dễ — Thuật toán chuẩn có kiểm tra tính hợp lệ của range không?
