...
Algorithms generally trust their iterator ranges and documented preconditions; they do not validate that two iterators form a valid range or that an ordering requirement holds. Violating those contracts can make the program undefined.
...
1. Easy — Do algorithms validate ranges?
