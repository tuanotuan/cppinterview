# Câu 130: Khai báo string này có biên dịch không?
...
Khi đã include `<string>`, `std::string(foo);` được parse như khai báo `std::string foo;`, nên nó tạo string rỗng chứ không phải temporary bị bỏ. Không nên dựa vào `<iostream>` include bắc cầu `<string>`; hãy viết rõ khai báo mong muốn.
...
1. Khó — Khai báo string này có biên dịch không?
