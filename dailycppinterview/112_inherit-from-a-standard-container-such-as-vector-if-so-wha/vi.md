# Câu 112: Có thể kế thừa từ container chuẩn như `std::vector` không? Nếu có thì hệ quả là gì?
...
Kế thừa từ container chuẩn hợp lệ về cú pháp nhưng thường là public abstraction sai vì container không phải polymorphic base và không có virtual destructor. Composition giữ invariant và giới hạn API được lộ.
