# Câu 092: Dynamic dispatch là gì?
...
Dynamic dispatch là việc runtime chọn final overrider cho lời gọi virtual dựa trên dynamic type của object. Nó cần dùng object đa hình qua pointer hoặc reference thay vì slicing theo giá trị.
