# Question 092: What does dynamic dispatch mean?
...
Dynamic dispatch is runtime selection of the final overrider for a virtual call based on the object's dynamic type. It requires using the object polymorphically through a pointer or reference rather than slicing it by value.
...
1. Hard — What does dynamic dispatch mean?
