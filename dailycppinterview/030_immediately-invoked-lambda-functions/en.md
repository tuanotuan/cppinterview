# Question 030: What are immediately invoked lambda functions?
...
An immediately invoked lambda expression places the call `()` directly after the lambda, such as `auto value = [&] { return compute(); }();`. It creates a small local scope for complex one-time initialization without leaving a callable behind.
...
1. Easy — What are immediately invoked lambda functions?
