# Câu 032: Đoạn mã sau in gì và vì sao?
...
Kết quả là `1`. Object không const chọn overload non-const; việc biến nhận kết quả là const không thể làm lời gọi trước đó chuyển sang const member function.
