# Question 032: What is the output of the following piece of code and why?
...
The output is `1`. The non-const object selects the non-const overload; making the destination variable const does not retroactively select the const member function.
