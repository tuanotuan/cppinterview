...
It does not compile at the member call. `MyObject o();` declares a function named `o` returning `MyObject`; it does not construct an object. Use `MyObject o;` or `MyObject o{};`.
...
1. Hard — Does this code compile? If yes, what does it do? If not, why not?
