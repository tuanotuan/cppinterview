# Câu 133: Đoạn mã này có biên dịch không? Nếu có, nó làm gì? Nếu không, vì sao?
...
Đoạn mã không compile tại lời gọi member. `MyObject o();` khai báo một hàm tên `o` trả `MyObject`, không xây dựng object. Hãy dùng `MyObject o;` hoặc `MyObject o{};`.
...
1. Khó — Đoạn mã này có biên dịch không? Nếu có, nó làm gì? Nếu không, vì sao?
