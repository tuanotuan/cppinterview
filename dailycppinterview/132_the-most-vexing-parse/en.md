...
The most vexing parse is C++'s rule for a syntactically ambiguous statement: if it can be parsed as a declaration, it is treated as a declaration. Braced initialization or an unambiguous variable form removes the ambiguity.
...
1. Easy — What is the most vexing parse?
