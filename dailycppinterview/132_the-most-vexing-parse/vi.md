# Câu 132: Most vexing parse là gì?
...
Most vexing parse là quy tắc xử lý câu lệnh C++ mơ hồ về cú pháp: nếu có thể parse thành declaration thì nó được xem là declaration. Braced initialization hoặc dạng khai báo biến không mơ hồ sẽ loại bỏ vấn đề.
