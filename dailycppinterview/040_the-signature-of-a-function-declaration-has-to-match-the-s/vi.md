# Câu 040: Chữ ký khai báo hàm có phải khớp chữ ký định nghĩa hàm không?
...
Các khai báo của cùng một hàm phải thống nhất kiểu tham số và qualifier của hàm; nếu không, chúng biểu diễn overload khác hoặc không khớp định nghĩa. Chỉ kiểu trả về không thể phân biệt overload, còn default argument không thuộc function type.
...
1. Trung bình — Chữ ký khai báo hàm có phải khớp chữ ký định nghĩa hàm không?
