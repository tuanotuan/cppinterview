# Câu 129: Giá trị cuối cùng của `a`, `b` và `c` là gì?
...
Giá trị cuối là `a == 9`, `b == 10`, `c == 11`. Phép nhân chạy trước phép cộng nên `c` ban đầu thành 10; postfix `c++` gán giá trị cũ đó cho `b` rồi mới tăng `c`.
...
1. Khó — Giá trị cuối cùng của `a`, `b` và `c` là gì?
