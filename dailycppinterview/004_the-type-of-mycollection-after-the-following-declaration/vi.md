# Câu 004: `myCollection` có kiểu gì sau khai báo sau?
...
`auto myCollection = {1, 2, 3};` suy luận thành `std::initializer_list<int>`. Tất cả phần tử phải cho phép suy luận ra cùng một kiểu phần tử.
