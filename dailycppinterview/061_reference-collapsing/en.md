# Question 061: What is reference collapsing?
...
Reference collapsing reduces nested reference formation to one reference: any combination containing `&` becomes `&`, and only `&&` combined with `&&` remains `&&`. This is what lets forwarding references preserve the caller's value category.
...
1. Hard — What is reference collapsing?
