# Câu 002: Khi nào `auto` có thể suy luận ra kiểu không mong muốn?
...
`auto` giữ kiểu thực của biểu thức khởi tạo, nên có thể nhận một proxy ẩn như `std::vector<bool>::reference` thay vì `bool`. Hãy ép về kiểu giá trị mong muốn khi proxy có thể sống lâu hơn owner hoặc gây hành vi bất ngờ.
...
1. Trung bình — Khi nào `auto` có thể suy luận ra kiểu không mong muốn?
