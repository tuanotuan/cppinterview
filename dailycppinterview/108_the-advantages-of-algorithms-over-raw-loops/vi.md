# Câu 108: Thuật toán chuẩn có lợi thế gì so với vòng lặp viết tay?
...
Standard algorithm biểu diễn ý định, kết hợp với abstraction iterator/range, giảm lỗi biên tự viết và có thể nhận tối ưu hoặc execution policy từ implementation. Vòng lặp tay vẫn phù hợp khi operation không thể diễn đạt rõ bằng algorithm.
...
1. Dễ — Thuật toán chuẩn có lợi thế gì so với vòng lặp viết tay?
