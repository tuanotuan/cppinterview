# Câu 017: Kế thừa ảo trong C++ là gì và khi nào nên dùng?
...
Kế thừa ảo làm cho mọi nhánh trong cấu trúc kim cương dùng chung một base subobject. Constructor của lớp dẫn xuất cuối cùng khởi tạo virtual base đó; cách này loại bỏ state trùng nhưng làm layout và construction phức tạp hơn.
...
1. Khó — Kế thừa ảo trong C++ là gì và khi nào nên dùng?
