...
A virtual call inside construction or destruction dispatches only within the class whose constructor or destructor is active. More-derived overrides are not selected because those subobjects are not yet, or are no longer, alive.
