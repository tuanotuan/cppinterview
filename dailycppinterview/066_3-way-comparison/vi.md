# Câu 066: Three-way comparison là gì?
...
Toán tử ba chiều `<=>` trả về ordering category như strong, weak hoặc partial ordering. Comparison được default có thể sinh phép so sánh member theo thứ tự từ điển và hỗ trợ các relational operator được viết lại; việc sinh `==` tuân theo quy tắc riêng của chuẩn.
...
1. Dễ — Three-way comparison là gì?
