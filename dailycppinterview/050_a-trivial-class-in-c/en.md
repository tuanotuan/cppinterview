# Question 050: What is a trivial class in C++?
...
A trivial class has eligible special member operations and destruction that are trivial and has no virtual machinery that would require custom runtime work. Exact traits vary by operation and standard, so test the property you need with the corresponding type trait.
...
1. Easy — What is a trivial class in C++?
