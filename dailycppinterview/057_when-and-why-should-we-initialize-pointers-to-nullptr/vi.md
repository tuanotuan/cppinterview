# Câu 057: Khi nào và vì sao nên khởi tạo con trỏ bằng `nullptr`?
...
Khởi tạo pointer bằng `nullptr` khi trạng thái rỗng là hợp lệ và chưa có target thật, để việc kiểm tra có hành vi xác định. Nếu có thể, nên khởi tạo ngay tới target hợp lệ vì null thêm một trạng thái mà mọi nơi sử dụng phải xử lý.
...
1. Dễ — Khi nào và vì sao nên khởi tạo con trỏ bằng `nullptr`?
