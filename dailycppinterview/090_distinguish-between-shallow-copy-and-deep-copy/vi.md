# Câu 090: Phân biệt shallow copy và deep copy.
...
Shallow copy sao chép handle nên hai object vẫn trỏ cùng resource nền; deep copy tạo resource độc lập có giá trị tương đương. Lựa chọn đúng phụ thuộc ownership và value semantics của type.
...
1. Dễ — Phân biệt shallow copy và deep copy.
