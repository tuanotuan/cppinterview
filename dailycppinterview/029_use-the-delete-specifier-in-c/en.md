# Question 029: How to use the = delete specifier in C++?
...
Writing `= delete` declares a function but makes every selected use ill-formed. It is useful for disabling copying, dangerous overloads, or implicit conversions while still letting overload resolution produce a precise diagnostic.
...
1. Medium — How to use the = delete specifier in C++?
