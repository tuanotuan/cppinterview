# Câu 029: Dùng đặc tả `= delete` trong C++ như thế nào?
...
Viết `= delete` vẫn khai báo hàm nhưng khiến mọi cách dùng chọn trúng hàm đó trở thành ill-formed. Nó hữu ích để cấm copy, overload nguy hiểm hoặc implicit conversion, đồng thời giúp overload resolution đưa ra diagnostic rõ ràng.
...
1. Trung bình — Dùng đặc tả `= delete` trong C++ như thế nào?
