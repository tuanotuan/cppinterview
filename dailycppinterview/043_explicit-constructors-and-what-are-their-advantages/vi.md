# Câu 043: Explicit constructor là gì và có lợi ích nào?
...
Constructor hoặc conversion function `explicit` không thể bị dùng cho implicit conversion ngoài ý muốn trong copy initialization hay truyền tham số. Direct initialization vẫn dùng được, nên call site phải thể hiện conversion có chủ ý.
...
1. Dễ — Explicit constructor là gì và có lợi ích nào?
