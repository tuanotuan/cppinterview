# Question 043: What are explicit constructors and what are their advantages?
...
An `explicit` constructor or conversion function cannot be used for unwanted implicit conversion in copy initialization or argument passing. Direct initialization remains available, so the call site must state the conversion intentionally.
...
1. Easy — What are explicit constructors and what are their advantages?
