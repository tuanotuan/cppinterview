# Câu 067: Giải thích `consteval` và `constinit` mang lại điều gì cho C++?
...
`consteval` biến hàm thành immediate function nên các lời gọi được đánh giá phải là constant expression. `constinit` bảo đảm static initialization cho object có static hoặc thread storage nhưng không thêm constness.
...
1. Khó — Giải thích `consteval` và `constinit` mang lại điều gì cho C++?
