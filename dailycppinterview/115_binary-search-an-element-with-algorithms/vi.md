# Câu 115: Dùng algorithm để tìm kiếm nhị phân một phần tử!
...
`std::binary_search` yêu cầu range được partition theo cùng ordering dùng để tìm kiếm, điều mà range được sort bình thường đáp ứng. Hãy sort trước hoặc duy trì invariant; gọi nó trên mẫu chưa sort vi phạm precondition nên không thể tin kết quả.
...
1. Trung bình — Dùng algorithm để tìm kiếm nhị phân một phần tử!
