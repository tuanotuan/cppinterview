# Câu 074: Nên `delete` tường minh special function không hỗ trợ hay khai báo nó là `private`?
...
`= delete` ở public là lựa chọn hiện đại vì nó mô tả operation bị cấm và cho overload resolution chẩn đoán trực tiếp. Khai báo private mà không định nghĩa là kỹ thuật cũ, có thể trì hoãn hoặc làm mơ hồ lỗi.
...
Dùng kiến thức này khi review API, đọc code, giải thích diagnostic hoặc thiết kế abstraction có liên quan đến special member function. Trong code production, hãy ưu tiên dạng làm contract hiện rõ và được compiler kiểm tra.
