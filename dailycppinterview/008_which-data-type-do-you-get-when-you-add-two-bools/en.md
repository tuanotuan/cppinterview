# Question 008: Which data type do you get when you add two bools?
...
Both operands undergo integral promotion from `bool` to `int`, so adding two `bool` values produces an `int`. Its value is 0, 1, or 2.
...
1. Easy — Which data type do you get when you add two bools?
