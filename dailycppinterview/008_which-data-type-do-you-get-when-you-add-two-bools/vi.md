# Câu 008: Khi cộng hai giá trị `bool`, ta nhận được kiểu dữ liệu nào?
...
Cả hai toán hạng `bool` được integral promotion thành `int`, vì vậy phép cộng hai `bool` cho kết quả kiểu `int`, với giá trị 0, 1 hoặc 2.
...
1. Dễ — Khi cộng hai giá trị `bool`, ta nhận được kiểu dữ liệu nào?
