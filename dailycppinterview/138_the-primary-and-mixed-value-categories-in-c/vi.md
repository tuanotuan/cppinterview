# Câu 138: Các value category cơ bản và hỗn hợp trong C++ là gì?
...
Các value category cơ bản là lvalue, xvalue và prvalue. Glvalue gồm lvalue cộng xvalue vì cả hai xác định identity; rvalue gồm prvalue cộng xvalue vì resource của chúng thường có thể tham gia operation hướng move.
...
1. Dễ — Các value category cơ bản và hỗn hợp trong C++ là gì?
