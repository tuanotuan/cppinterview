...
Declare one variable per statement. It makes each type, pointer declarator, initializer, lifetime, and comment unambiguous and avoids the false impression that one initializer applies to every name.
...
1. Easy — How many variables should you declare on a line?
