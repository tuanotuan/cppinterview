# Câu 142: Nên khai báo bao nhiêu biến trên một dòng?
...
Nên khai báo một biến trên mỗi statement. Cách này làm rõ kiểu, pointer declarator, initializer, lifetime và comment của từng biến, đồng thời tránh hiểu nhầm một initializer áp dụng cho mọi tên.
...
1. Dễ — Nên khai báo bao nhiêu biến trên một dòng?
