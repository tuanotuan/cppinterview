# Question 027: What is a destructor and how can we overload it?
...
A destructor ends an object's lifetime and releases resources owned by it. A class can have only one destructor, so destructors cannot be overloaded; it may be virtual, defaulted, deleted, or given an exception specification.
...
1. Easy — What is a destructor and how can we overload it?
