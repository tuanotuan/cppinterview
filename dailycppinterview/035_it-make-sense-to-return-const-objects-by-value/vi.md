# Câu 035: Trả đối tượng `const` theo giá trị có hợp lý không?
...
Thường là không. Top-level const trên giá trị trả về không bảo vệ lâu dài cho caller và có thể cản trở move trong code cũ hoặc generic. Hãy trả giá trị thường và để caller quyết định object nhận có const hay không.
...
1. Trung bình — Trả đối tượng `const` theo giá trị có hợp lý không?
