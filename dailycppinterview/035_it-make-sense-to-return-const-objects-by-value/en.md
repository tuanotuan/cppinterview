# Question 035: Does it make sense to return const objects by value?
...
Usually no. Top-level const on a returned value gives the caller no durable protection and can inhibit moving in older or generic code. Return an ordinary value and let the caller decide whether its receiving object is const.
...
1. Medium — Does it make sense to return const objects by value?
