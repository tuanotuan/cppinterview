# Câu 119: Hàm ảo có thể có default argument không?
...
Có, virtual function có thể có default argument, nhưng default được bind tĩnh còn function body dispatch động. Lời gọi qua base vì thế có thể chạy override dẫn xuất với giá trị mặc định từ khai báo base; nên tránh kết hợp này.
...
1. Khó — Hàm ảo có thể có default argument không?
