# Câu 120: Destructor của lớp cơ sở có nên là `virtual` không?
...
Dùng destructor public virtual cho base được thiết kế để xóa đa hình. Dùng destructor protected non-virtual khi phải cấm xóa qua base; không phải base class nào cũng cần virtual destruction.
