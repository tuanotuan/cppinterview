# Câu 114: `const_iterator` có lợi thế gì so với iterator?
...
`const_iterator` cho phép duyệt mà không mutation qua iterator đó, dùng tự nhiên với const container và truyền đạt ý định chỉ đọc cho compiler lẫn reviewer. Nó không làm container nền bất biến qua mọi alias khác.
...
1. Dễ — `const_iterator` có lợi thế gì so với iterator?
