# Câu 083: Default argument là gì và được đánh giá như thế nào trong hàm C++?
...
Default argument được thay tại call site từ khai báo nhìn thấy ở đó và theo static type của hàm; biểu thức của nó được đánh giá khi lời gọi chạy. Default không dynamic dispatch, nên kết hợp với virtual function có thể gây bất ngờ.
...
1. Khó — Default argument là gì và được đánh giá như thế nào trong hàm C++?
