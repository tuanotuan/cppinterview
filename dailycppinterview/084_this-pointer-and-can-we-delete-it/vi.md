# Câu 084: Con trỏ `this` là gì và có thể `delete` nó không?
...
`this` là pointer ẩn tới object hiện tại trong non-static member function. `delete this` chỉ khả thi về kỹ thuật dưới contract self-ownership rất chặt cho heap object và không còn truy cập sau đó; thiết kế này dễ lỗi và thường nên thay bằng ownership tường minh.
...
1. Khó — Con trỏ `this` là gì và có thể `delete` nó không?
