# Câu 044: User-defined literal là gì?
...
User-defined literal ánh xạ suffix như `_km` tới literal operator tạo một giá trị có kiểu ở compile time hoặc runtime. Nó giúp domain rõ hơn; suffix bắt đầu bằng dấu gạch dưới là không gian phù hợp cho code người dùng.
...
1. Dễ — User-defined literal là gì?
