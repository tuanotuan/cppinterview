# Câu 118: Default argument là gì và được đánh giá như thế nào trong hàm C++?
...
Default argument được chọn từ khai báo nhìn thấy tại call site theo static type rồi mới được đánh giá khi lời gọi chạy. Nó không thuộc virtual dispatch và việc thay đổi có thể yêu cầu compile lại caller.
