# Câu 049: Dùng đặc tả `= delete` trong C++ như thế nào?
...
Viết `= delete` khai báo hàm nhưng cấm mọi cách dùng được overload resolution chọn tới nó. Ngoài special member, deleted overload còn có thể chặn conversion không an toàn và tạo diagnostic rõ ràng.
