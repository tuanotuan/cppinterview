# Question 056: Should you use smart pointers over raw pointers all the time?
...
No. Smart pointers should represent ownership; raw pointers and references remain appropriate non-owning observers, and automatic objects need no pointer. The important rule is that every owning relationship is explicit and unambiguous.
...
1. Medium — Should you use smart pointers over raw pointers all the time?
