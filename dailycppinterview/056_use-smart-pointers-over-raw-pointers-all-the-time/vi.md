# Câu 056: Có nên luôn dùng smart pointer thay cho raw pointer không?
...
Không. Smart pointer nên biểu diễn ownership; raw pointer và reference vẫn phù hợp làm observer non-owning, còn automatic object không cần pointer. Quy tắc quan trọng là mọi quan hệ sở hữu phải tường minh và không mơ hồ.
...
1. Trung bình — Có nên luôn dùng smart pointer thay cho raw pointer không?
