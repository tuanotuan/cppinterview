# Câu 110: Có thể kết hợp các container có kích thước khác nhau không?
...
Một số algorithm nhận nhiều range, nhưng overload chỉ nhận iterator đầu của range phụ sẽ giả định có đủ phần tử. Cần kiểm tra size hoặc dùng interface mang cả hai đầu; C++ ranges cải thiện nhiều API nhưng không xóa mọi precondition.
...
1. Khó — Có thể kết hợp các container có kích thước khác nhau không?
