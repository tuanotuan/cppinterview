...
Neither form is universally preferable. Default arguments are concise when one operation truly has a stable default, but values are compiled into callers and interact badly with virtual dispatch; overloads support distinct contracts and can preserve binary compatibility at the cost of more API surface.
...
1. Hard — Should you prefer default arguments or overloading?
