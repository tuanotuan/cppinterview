# Câu 141: Nên ưu tiên default argument hay overload?
...
Không có lựa chọn luôn tốt hơn. Default argument gọn khi một operation thật sự có default ổn định, nhưng giá trị được compile vào caller và tương tác kém với virtual dispatch; overload hỗ trợ contract riêng và có thể giữ binary compatibility, đổi lại API rộng hơn.
...
1. Khó — Nên ưu tiên default argument hay overload?
