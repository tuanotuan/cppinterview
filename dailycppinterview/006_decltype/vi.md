...
`decltype` trả kiểu đã khai báo đối với một tên không có ngoặc; với biểu thức khác, nó còn phản ánh value category: lvalue cho `T&`, xvalue cho `T&&`, prvalue cho `T`. Vì vậy thêm ngoặc có thể đổi kết quả.
