# Câu 103: Undefined behavior trong C++ là gì?
...
Undefined behavior xảy ra khi chuẩn không đặt yêu cầu nào sau khi một rule hoặc precondition bị vi phạm. Optimizer có thể giả định nó không bao giờ xảy ra, nên một lần chạy quan sát được không chứng minh kết quả ổn định.
...
1. Dễ — Undefined behavior trong C++ là gì?
