# Câu 140: `main` trả gì và có những chữ ký hợp lệ nào?
...
`main` chuẩn trả `int`; các chữ ký thường dùng là `int main()` và `int main(int argc, char* argv[])`, ngoài ra implementation có thể hỗ trợ dạng khác. Đi hết body tương đương trả 0 và `argc` tính cả tên chương trình khi dương.
...
1. Dễ — `main` trả gì và có những chữ ký hợp lệ nào?
