...
Hàm ảo cho phép dynamic dispatch: lời gọi qua base pointer hoặc reference chọn final overrider theo dynamic type của object. Gọi trên object theo giá trị vẫn có thể bị ảnh hưởng bởi slicing.
