# Câu 060: Universal reference và rvalue reference khác nhau thế nào?
...
`T&&` chỉ là forwarding reference khi `T` không có cv-qualifier và được suy luận trong ngữ cảnh đó (hoặc dạng `auto&&` tương ứng). Trường hợp khác, nó là rvalue reference thường chỉ bind rvalue; khác biệt này chi phối reference collapsing và forwarding.
...
1. Khó — Universal reference và rvalue reference khác nhau thế nào?
