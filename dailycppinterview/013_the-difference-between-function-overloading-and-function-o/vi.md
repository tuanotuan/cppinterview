# Câu 013: Function overloading và function overriding khác nhau như thế nào?
...
Overloading chọn giữa các hàm cùng tên nhưng khác danh sách tham số, thường ở compile time. Overriding cung cấp implementation ở lớp dẫn xuất cho hàm ảo của lớp cơ sở có chữ ký khớp và tham gia runtime dispatch.
...
1. Trung bình — Function overloading và function overriding khác nhau như thế nào?
