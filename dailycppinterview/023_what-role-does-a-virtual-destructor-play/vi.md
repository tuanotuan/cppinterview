# Câu 023: Destructor ảo có vai trò gì?
...
Destructor ảo ở lớp cơ sở bảo đảm `delete` qua base pointer sẽ hủy toàn bộ object dẫn xuất. Nếu thiếu nó, thao tác đó là undefined behavior; base không đa hình có thể dùng destructor non-virtual `protected` để cấm xóa qua base.
...
1. Dễ — Destructor ảo có vai trò gì?
