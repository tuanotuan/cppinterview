...
The declaration deduces `std::initializer_list<int>` because copy-list initialization with `auto` uses the initializer-list deduction rule. The elements must agree on one deduced element type.
