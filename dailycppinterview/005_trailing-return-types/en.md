# Question 005: What are trailing return types?
...
A trailing return type writes the return after the parameter list, as in `auto f(T value) -> Result`. It is useful when the return type depends on parameters or when a member type is easier to name after entering class scope.
...
1. Easy — What are trailing return types?
