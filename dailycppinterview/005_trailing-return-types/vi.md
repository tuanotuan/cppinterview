# Câu 005: Kiểu trả về đặt sau (trailing return type) là gì?
...
Trailing return type đặt kiểu trả về sau danh sách tham số, ví dụ `auto f(T value) -> Result`. Nó hữu ích khi kiểu trả về phụ thuộc tham số hoặc khi member type dễ gọi tên hơn sau khi đã vào scope của lớp.
...
1. Dễ — Kiểu trả về đặt sau (trailing return type) là gì?
