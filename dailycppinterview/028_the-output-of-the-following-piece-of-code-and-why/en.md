# Question 028: What is the output of the following piece of code and why?
...
The output is `1`. Overload resolution uses the cv-qualification of object `a`, which is non-const, so it calls the non-const member; the `const` on result variable `b` does not affect that earlier call.
...
1. Medium — What is the output of the following piece of code and why?
