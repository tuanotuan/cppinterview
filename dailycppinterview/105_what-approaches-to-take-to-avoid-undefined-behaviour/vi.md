# Câu 105: Có những cách nào để tránh undefined behavior?
...
Tránh undefined behavior bằng invariant và ownership tường minh, kiểm tra input cùng precondition thư viện, bật warning mạnh và chạy sanitizer/test. Ưu tiên RAII, abstraction có bounds và scope nhỏ để invalid state khó được biểu diễn.
...
1. Khó — Có những cách nào để tránh undefined behavior?
