...
|---|---|---|
| `/` | `web/src/app/page.tsx`, `recall-landing-page.tsx` | Landing public của Recall: giới thiệu luồng học, thư viện, AI coach, mock interview và GitHub OAuth; luôn là trang chủ, kể cả khi người dùng đang đăng nhập |
