...
| `ai` | `public-ai-quota.server.ts` | Admission server-only cho AI public: HMAC IP/device/account, cửa sổ rolling 24 giờ, lease chống gọi trùng và Supabase secret key riêng |
