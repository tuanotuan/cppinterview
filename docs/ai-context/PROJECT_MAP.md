...
| `/learn/roadmap/cpp11` | `[locale]/learn/roadmap/cpp11/page.tsx`, `app/learn/cpp11-roadmap-app.tsx`, `app/learn/cpp11-roadmap-map.tsx`, `lib/learn/cpp11-roadmap.ts` | Roadmap C++11 song ngữ gồm 53 ngày/8 chặng; server dựng nội dung còn client leaf render sơ đồ node/connector ba cột ziczac trên desktop và một trục dọc trên tablet/mobile. Chọn node mở dialog accessible và cập nhật deep link `#day-N`; trạng thái chỉ phản ánh học liệu `ready`/`partial`/`planned`, không đọc hay giả lập tiến độ người học |
