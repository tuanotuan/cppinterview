...
Learning/Relearning đến hạn, tối đa năm Review đến hạn và tối đa một New theo
thứ tự đó; review cùng ngày chỉ hoàn tất ID đã chọn nên reload/cloud merge không
tự bổ sung quota hoặc làm tăng mẫu số. Panel Today gộp Relearning vào “Đang học”
và chỉ đếm phần còn lại của plan; bốn learning state vẫn giữ nguyên cho badge,
lọc chi tiết và transition. Repair, Custom Study và Focus là queue riêng.
